...
export default function Home() {
  return (
    <section>
  <div className="mx-auto max-w-screen-2xl px-4 mt-4 sm:px-6 lg:px-8">
      ...
      <div className="shadow-2xl flex flex-col justify-center box-border text-black p-8 md:p-12 lg:px-16 lg:py-24">
        <div className="mx-auto max-w-xl text-center">
          ...
          <div className="mt-4 md:mt-8">
            <a
              href="/post"
              className="inline-block rounded-xl border border-white bg-black px-12 py-3 text-sm font-medium text-white transition hover:bg-gray-500 focus:outline-none focus:ring focus:ring-yellow-400"
            >
